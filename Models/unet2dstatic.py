...
def unet(pretrained_weights = None,input_size = (256,256,1), channels=1):
    ...
    if channels == 1:
        ...
        activation = Conv2D(1, 1, activation = 'sigmoid')(conv9)
        model = Model(input = inputs, output = activation)
        model.compile(optimizer = Adam(lr = 1e-4), loss=losses.binary_crossentropy, metrics=[dice_coef])
    else:    
        conv9 = Conv2D(channels, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv9)
